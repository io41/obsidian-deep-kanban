Based on [Obsidian Kanban Plugin](https://github.com/mgmeyers/obsidian-kanban) by mgmeyers.

# Deep Kanban

Create nestable markdown-backed Kanban boards in [Obsidian](https://obsidian.md/)
...
Not currently published via Obsidian plugin repository. Install via [BRAT](https://github.com/TfTHacker/obsidian42-brat).
