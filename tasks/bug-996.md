...
os: macOS
status: verified
investigation_notes: "Code at ItemMenu.ts:69-74 correctly reads new-note-folder setting and uses getAbstractFileByPath. Issue might be: (1) folder doesn't exist and falls back silently, (2) per-board setting overriding global, (3) setting key typo. Needs reproduction to debug."
fix_attempted: false
fix_pr: ""
---
