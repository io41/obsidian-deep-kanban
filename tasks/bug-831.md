...
os: Windows
status: fixed
investigation_notes: "Date color priority issue - longer time spans override shorter ones. Fixed by changing sort order to use distance from now instead of simple date comparison. Shorter time spans are now checked first."
fix_attempted: true
fix_pr: ""
---
