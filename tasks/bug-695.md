...
os: Windows
status: fixed
investigation_notes: "Local board setting 'max-archive-size' wasn't in compiledSettings, so during initial render before state was fully loaded, it would fall back to global. Added max-archive-size to compiledSettings in StateManager.ts."
fix_attempted: true
fix_pr: ""
---
