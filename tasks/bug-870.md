...
os: macOS
status: verified
investigation_notes: "Archive completed cards incorrectly includes cancelled [-] and in-progress [/] tasks, changing their status to [x]. Should: 1) Only archive truly completed [x] tasks, 2) Preserve original status markers when archiving. Tasks plugin compatibility concern. Needs boardModifiers.ts archiveCompleted logic review."
fix_attempted: false
fix_pr: ""
---
