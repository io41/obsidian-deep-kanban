...
os: Windows
status: fixed
investigation_notes: "Non-markdown files (pdf, images, docx) being rendered as embeds instead of links. The linkTo() function uses Obsidian's generateMarkdownLink which returns embed syntax (![[...]]) for non-md files. Fixed by stripping the ! prefix for non-markdown files in linkTo()."
fix_attempted: true
fix_pr: ""
---
