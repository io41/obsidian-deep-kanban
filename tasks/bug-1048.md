...
os: Windows
status: duplicate
investigation_notes: "Same as #1036, #810. Date colors and relative date text don't update when day changes without restarting. Need periodic refresh mechanism for date-relative calculations."
fix_attempted: false
fix_pr: ""
---
