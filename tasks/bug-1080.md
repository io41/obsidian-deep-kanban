...
os: Linux
status: wontfix
investigation_notes: "By design: 'due' is in taskFields set and treated specially. Task fields (due, start, created, scheduled, completion) are only extracted from the first line to avoid picking up mentions in card descriptions. This matches Tasks plugin conventions."
fix_attempted: false
fix_pr: ""
---
