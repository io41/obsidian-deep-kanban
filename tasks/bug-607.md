...
os: Windows
status: duplicate
investigation_notes: "DnD stops working in maximized secondary window when main window not visible. Error: 'Cannot read properties of undefined'. Related to #603 (popout window issues). Same root cause - DnD system loses references when main window hidden."
fix_attempted: false
fix_pr: ""
---
